...
const NavBotton = () => {
	...
	return (
		<div className="max-md:hidden space-x-2">
			...
			<button className="group enabled:hover:bg-slate-800 p-1 rounded-md outline-none" onClick={goForward}>
				<svg xmlns="http://www.w3.org/2000/svg" className="size-[37px] stroke-customWhite group-disabled:stroke-customGray" viewBox="0 0 24 24" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round">
					<path stroke="none" d="M0 0h24v24H0z" fill="none"/>
