	...
	return (
		<div className="w-1/2 max-md:w-11/12 h-[47.5px] p-2 flex space-x-2">
			...
			<button className={`${isSearching ? "bg-slate-700" : "bg-inherit md:hover:bg-slate-800"} p-1 rounded-md outline-none`} onClick={() => setIsSearching(!isSearching)}>
				<svg xmlns="http://www.w3.org/2000/svg" className="size-[25px] stroke-customWhite" viewBox="0 0 24 24" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round">
					<path stroke="none" d="M0 0h24v24H0z" fill="none"/>
