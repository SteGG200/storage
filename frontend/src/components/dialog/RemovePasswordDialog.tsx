				...
				<form onSubmit={submit} className="space-y-4">
					<div className="p-3 bg-red-900/30 border border-red-700 rounded-md">
						<p className="text-sm text-red-400">
							Warning: This will remove password protection from this folder.
							Anyone will be able to access this directory.
						</p>
					</div>
					<Input
						name="oldPassword"
					...
					<div className="flex space-x-2">
						<Button
							type="button"
							variant="outline"
							className="flex-1 text-gray-300 border-gray-700 hover:bg-gray-700 bg-transparent"
							onClick={backAction}
							disabled={isLoading}
						>
