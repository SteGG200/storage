...
export default function ManagePasswordDialog({
	...
	const [isManagePasswordDialogOpen, setIsManagePasswordDialogOpen] = useState(false)
	const [isChangePasswordDialogOpen, setIsChangePasswordDialogOpen] = useState(false)
	const [isRemovePasswordDialogOpen, setIsRemovePasswordDialogOpen] = useState(false)
	...
	return (
		<>
			<Dialog open={isManagePasswordDialogOpen} onOpenChange={setIsManagePasswordDialogOpen}>
			...
			<ChangePasswordDialog path={path} open={isChangePasswordDialogOpen} onOpenChange={setIsChangePasswordDialogOpen} onBackAction={setIsManagePasswordDialogOpen}/>
			<RemovePasswordDialog path={path} open={isRemovePasswordDialogOpen} onOpenChange={setIsRemovePasswordDialogOpen} onBackAction={setIsManagePasswordDialogOpen}/>
		</>
	)
}