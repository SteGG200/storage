...
export default function RenameDialog({ path }: RenameDialogProps) {
	const queryClient = useQueryClient();
	const { modifyingItem, isRenameDialogOpen, setIsRenameDialogOpen } =
	...
	return (
		<Dialog open={isRenameDialogOpen} onOpenChange={setIsRenameDialogOpen}>
			<DialogContent>
				<DialogHeader>
					<DialogTitle>
						Rename {modifyingItem?.isDirectory ? 'Folder' : 'File'}
					</DialogTitle>
				</DialogHeader>
